...
swift-ring-builder object.builder add --region 1 --zone 1 --ip 127.0.0.1 --port 6010 --device sdb --weight 100
...
swift-ring-builder container.builder add --region 1 --zone 1 --ip 127.0.0.1 --port 6011 --device sdb --weight 100
...
swift-ring-builder account.builder add --region 1 --zone 1 --ip 127.0.0.1 --port 6012 --device sdb --weight 100
